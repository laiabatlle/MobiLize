...
public interface PerfilInterface {
    ...
    interface Presenter{
        void toGuardarCambios(String username, String email, String dateNaixement, String gendre, String weight, String height, String image/*, String privacity*/);
    ...
    interface Model{
        void haveAnyFriendReq(String username);
        void doGuardarCambios(String username, String email, String dateNaixement, String gendre, String weight, String height, String image/*, String privacity*/);
